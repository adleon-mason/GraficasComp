function sprite () {
    this.width = 54720; // ****el ancho todal de mi spritesheet***
    ...
    this.scaleX = 1;
    this.scaleY = 1;
    //this.totalSpriteFrames = 95; //***este es el numero total de frames en mi spritesheet***
  }
    var frameIndex = 0;
    var tickCount = 0;
    var ticksPerFrame = 2; //funciona para controlar los fps, si es 4 son 15fps
    var numberOfFrames = 114; //*** El numero de frames que tiene mi spritesheet***
  ...
  sprite.prototype.draw = function (context) {
    ...
    marioImage.src = "calico.png"; // ***el nombre de tu imagen***
    update();
    context.save();
